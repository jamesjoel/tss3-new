                        ...
                        <div style={{ position: "absolute", bottom: "10px",  width: "95%"}}>
                            {
                                allMsg.map((item, index)=>{
                                    return(
                                        <p key={index} style={{ textAlign : item.userid=="user1" ? "right" : "left", margin : "0"}}>
                                                <span style={{backgroundColor : item.userid == "user1" ? "#5B86C5" : "#9AC55B"}}>{item.msg}</span>
                                        </p>        
                                    )
                                })
                            }
