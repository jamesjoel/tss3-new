    ...
    <div className="row">
        <div className="col-md-6 offset-md-3 my-4">
            ...
            <div className='my-2'>
                <label>Gender</label>
                <br />
                Male<input type='radio' checked={stu.gender=="male"} name='gender' onChange={addFrm.handleChange} value="male" />
                Female<input type='radio' checked={stu.gender=="female"} name='gender' onChange={addFrm.handleChange}  value="female"/>
                <br />
                {
